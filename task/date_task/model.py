...
from task.config import BERT_PRETRAIN_PATH, DATA_DIR
...
class BERTBILSTMCRF(object):
    def __init__(self,
        ...
        self.config_path = os.path.join(BERT_PRETRAIN_PATH, 'bert_config.json')
        self.check_point_path = os.path.join(BERT_PRETRAIN_PATH, 'bert_model.ckpt')
        self.dict_path = os.path.join(BERT_PRETRAIN_PATH, 'vocab.txt')
...
if __name__ == '__main__':
    ...
    model.save(os.path.join(DATA_DIR, "time_bert_ner.h5"))
    model.save_weights(os.path.join(DATA_DIR, "time_bert_ner_weight.h5"))
